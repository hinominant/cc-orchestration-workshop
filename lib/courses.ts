...
export const intermediateCourse: Course = {
  ...
  steps: [
    { id: 0, title: "環境準備", duration: "15分", description: "Claude Code 起動と agent-orchestrator の導入" },
    { id: 1, title: "要求定義をつくる", duration: "40分", description: "外部AI（GPT/Gemini）で要求定義書と要件定義書を作成する" },
    { id: 2, title: "組織をつくる", duration: "30分", description: "エージェントチームの組織図を設計する（監査役必須）" },
    { id: 3, title: "要求定義をぶち込む", duration: "20分", description: "Claude Code に要求定義書をコピペして開発をスタートする" },
    { id: 4, title: "開発をすすめる", duration: "60分", description: "Claude Codeが実装、あなたは質問に答えて方向を調整" },
    { id: 5, title: "テストと監査", duration: "40分", description: "テスト2回実行 + 要求定義・要件定義ベースの外部監査" },
    { id: 6, title: "仕上げ", duration: "30分", description: "README・要求定義書・要件定義書の最終確認と仕上げ" },
    { id: 7, title: "デプロイ", duration: "20分", description: "Vercelにデプロイしてデモ準備" },
